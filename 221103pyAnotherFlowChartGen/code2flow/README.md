## generate flowchat from Python
Further development required.
Intended for large python, js code. 
Summary of steps:
pip3 install code2flow
install graphviz

run
add code into mypythonfile.py for example using python code from engine.py from this repo)

use command: 
code2flow mypythonfile.py

see results in out.png and out.gv
